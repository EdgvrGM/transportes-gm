...
export default function FuelCamiones() {
  ...
  const eliminarMutation = useMutation({
    mutationFn: async (id) => {
      ...
      await supabase.from("Viaje").update({ camion_id: null }).eq("camion_id", id);
    ...
    onError: (err) => {
      if (err.message === "TIENE_VIAJES_ACTIVOS") {
        ...
        setDeleteError(err.message || "No se pudo eliminar el camión.");
      }
    },
  });
    ...
    <div className="p-4 md:p-8 bg-slate-50 dark:bg-background min-h-screen transition-colors duration-300">
      <div className="max-w-[1600px] mx-auto">
        ...
        <AlertDialog
          ...
          onOpenChange={() => { setCamionAEliminar(null); setDeleteError(null); }}
        >
              ...
              <div className="px-1 py-2 space-y-3">
                <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg px-4 py-3">
                  <p className="text-sm font-semibold text-amber-800 dark:text-amber-300">
                    Este camión tiene viajes registrados y no puede eliminarse.
                  </p>
                ...
                <div className="flex gap-2 justify-end">
                  ...
                  <Button
                    onClick={() => desactivarMutation.mutate(camionAEliminar.id)}
